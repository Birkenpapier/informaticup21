...
from connection import GameState, connection
import asyncio
import websockets

from speed_env import Snake
...
if __name__ == '__main__':
    ...
    # hier kommt die erste anfrage auf den server und wir warten dann bis es losgeht

    # env_spe_ed = GameState()
